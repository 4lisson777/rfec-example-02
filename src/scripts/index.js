...
const emptyProductsList = document.querySelector(".empty-products-list");
const searchForm = document.getElementById("search-form");
let cart = [];

/**
 * essa funcao filtra os produtos por categoria
 */
...
/*
 * essa funcao busca o produto a ser adicionado no carrinho e atualiza o array de produtos no carrinho.
 */
...
/**
 * essa funcao remove itens do carrinho.
 */
...
/**
 * essa funcao cria um elemento do produto no carrinho.
 */
function createCartProduct(product) {
    ...
    divTextContainer.append(h4, price, removeBtn);

    li.append(divImgContainer, divTextContainer);
    return li;
}
...
/**
 * essa funcao atualiza os totalizadores de quantidade e total do carrinho.
 */
...
/**
 * essa funcao atualiza a lista de produtos no carrinho.
 */
...
function listProducts(products) {
    ...
    if (products.length === 0) {
        ...
        emptyProductsList.classList.remove("d-none");
        return;
    }

    productsList.classList.remove("d-none");
    emptyProductsList.classList.add("d-none");
